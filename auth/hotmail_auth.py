"""
Hotmail/Outlook.com OAuth2.0 authentication implementation
Handles Microsoft Graph API authentication for personal Outlook accounts
"""
...
class HotmailAuth(BaseOAuth2Provider):
    """Hotmail/Outlook.com OAuth2.0 authentication provider"""
    
    def __init__(self):
        super().__init__('hotmail')
    
    def _get_auth_params(self) -> Dict[str, str]:
        """Get Hotmail-specific authorization parameters"""
        return {
            'response_mode': 'query',
    ...
    async def send_email(self, access_token: str, sender_email: str, 
        ...
        """Send email via Microsoft Graph API (same as Office365)"""
        headers = {
            'Authorization': f'Bearer {access_token}',
            'Content-Type': 'application/json'
        }
    ...
    async def test_connection(self, access_token: str) -> bool:
        """Test if the connection to Hotmail is working"""
        try:
    ...
    async def get_folders(self, access_token: str, email: str) -> list:
        """Get mail folders"""
        headers = {
            'Authorization': f'Bearer {access_token}',
            'Content-Type': 'application/json'
        ...
        url = f"{self.provider_config.api_base_url}/users/{email}/mailFolders"
    ...
    async def get_messages_count(self, access_token: str, email: str, folder_id: str = 'inbox') -> int:
        ...
        url = f"{self.provider_config.api_base_url}/users/{email}/mailFolders/{folder_id}/messages/$count"
